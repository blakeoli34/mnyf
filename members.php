...
<body class="membership">
	...
	<div class="page">
		<div class="col-12 white memberpage morepadding">
			...
			<div class="clear"></div>
			<div class="col-2">
				<a href="http://cysfresno.org"><img class="max" src="http://placehold.it/300x300" alt="Comprehensive Youth Services">Comprehensive Youth Services</a>
			</div>
			<div class="col-2">
				<a href="#"><img class="max" src="http://placehold.it/300x300" alt="Do’Chas">Do’Chas</a>
			</div>
			<div class="col-2">
				<a href="http://www.remixgenesee.org/everythingelse/short-term/"><img class="max" src="http://placehold.it/300x300" alt="Genesee County Youth Corporation">Genesee County Youth Corporation</a>
			</div>
			<div class="col-2">
